...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <title inertia>{{ config('app.name', 'Go Bong') }}</title>

    <!-- Favicon -->
    <link rel="icon" href="{{ asset('website/assets/logo/logo2.jpg') }}" />
  ...
  <body>
    ...
    <script src="{{ asset('website/assets/lib/lightbox/js/lightbox.min.js') }}"></script>
